...
// Initializing state variables
  ...
  useEffect(() => {
    if (session && session.user && session.user.userID && courseId) {
      fetchStudents(courseId as string);// fetch students in course by courseID
      fetchCourseName(courseId as string);// fetches course name by courseID
    }
  }, [session, courseId]);
